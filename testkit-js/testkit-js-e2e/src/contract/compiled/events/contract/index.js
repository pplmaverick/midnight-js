...
const _descriptor_4 = new __compactRuntime.CompactTypeBytes(80);

const _descriptor_5 = new __compactRuntime.CompactTypeBytes(49);

const _descriptor_6 = new __compactRuntime.CompactTypeBytes(578);

const _descriptor_7 = new __compactRuntime.CompactTypeBytes(81);

const _descriptor_8 = new __compactRuntime.CompactTypeBytes(288);

const _descriptor_9 = new __compactRuntime.CompactTypeBytes(256);
...
class _Maybe_0 {
  ...
  toValue(value_0) {
    return _descriptor_10.toValue(value_0.is_some).concat(_descriptor_1.toValue(value_0.value));
  }
}
...
class _Either_0 {
  alignment() {
    return _descriptor_10.alignment().concat(_descriptor_12.alignment().concat(_descriptor_13.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_10.toValue(value_0.is_left).concat(_descriptor_12.toValue(value_0.left).concat(_descriptor_13.toValue(value_0.right)));
  }
}
...
class _Maybe_1 {
  ...
  toValue(value_0) {
    return _descriptor_10.toValue(value_0.is_some).concat(_descriptor_2.toValue(value_0.value));
  }
}

const _descriptor_15 = new _Maybe_1();

const _descriptor_16 = new __compactRuntime.CompactTypeBytes(512);
...
class _Maybe_2 {
  ...
  toValue(value_0) {
    return _descriptor_10.toValue(value_0.is_some).concat(_descriptor_16.toValue(value_0.value));
  }
}

const _descriptor_17 = new _Maybe_2();
...
export class Contract {
    ...
    this.circuits = {
      emitMisc: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(name_0).concat(_descriptor_9.toValue(payload_0)),
        ...
        const result_0 = this._emitMisc_0(context,
                                          partialProofData,
                                          name_0,
                                          payload_0);
      ...
      emitShieldedSpend: (...args_1) => {
        ...
        const result_0 = this._emitShieldedSpend_0(context,
                                                   partialProofData,
                                                   nullifier_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost, events: context.events };
      },
      emitShieldedReceive: (...args_1) => {
        if (args_1.length !== 2) {
        ...
        const result_0 = this._emitShieldedReceive_0(context,
                                                     partialProofData,
                                                     commitment_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost, events: context.events };
      },
      emitShieldedMint: (...args_1) => {
        if (args_1.length !== 2) {
        ...
        const result_0 = this._emitShieldedMint_0(context,
                                                  partialProofData,
                                                  commitment_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost, events: context.events };
      },
      emitShieldedBurn: (...args_1) => {
        if (args_1.length !== 2) {
        ...
        const result_0 = this._emitShieldedBurn_0(context,
                                                  partialProofData,
                                                  nullifier_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost, events: context.events };
      },
      emitUnshieldedSpend: (...args_1) => {
        if (args_1.length !== 3) {
        ...
        const result_0 = this._emitUnshieldedSpend_0(context,
                                                     partialProofData,
                                                     tokenType_0,
                                                     amount_0);
        partialProofData.output = { value: [], alignment: [] };
      ...
      emitUnshieldedReceive: (...args_1) => {
        ...
        const result_0 = this._emitUnshieldedReceive_0(context,
                                                       partialProofData,
                                                       tokenType_0,
                                                       amount_0);
        partialProofData.output = { value: [], alignment: [] };
      ...
      emitUnshieldedMint: (...args_1) => {
        ...
        const result_0 = this._emitUnshieldedMint_0(context,
                                                    partialProofData,
                                                    tokenType_0,
                                                    amount_0);
        partialProofData.output = { value: [], alignment: [] };
      ...
      emitUnshieldedBurn: (...args_1) => {
        ...
        const result_0 = this._emitUnshieldedBurn_0(context,
                                                    partialProofData,
                                                    tokenType_0,
                                                    amount_0);
        partialProofData.output = { value: [], alignment: [] };
      ...
      emitLifecycle: (...args_1) => {
        ...
        const result_0 = this._emitLifecycle_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost, events: context.events };
      }
    };
  ...
  _emitMisc_0(context, partialProofData, name_0, payload_0) {
    let t_0;
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newArray()
                                                          .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_21.toValue(1n),
                                                                                                           alignment: _descriptor_21.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_20.toValue(10n),
                                                                                                                                                                                                     alignment: _descriptor_20.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue((t_0 = { name:
                                                                                                                                                                                                                                                                                                                                       name_0,
                                                                                                                                                                                                                                                                                                                                     payload:
                                                                                                                                                                                                                                                                                                                                       payload_0 },
  ...
  _emitShieldedSpend_0(context, partialProofData, nullifier_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newArray()
                                                          .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_21.toValue(1n),
                                                                                                           alignment: _descriptor_21.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_20.toValue(0n),
                                                                                                                                                                                                     alignment: _descriptor_20.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue({ nullifier:
  ...
  _emitShieldedReceive_0(context, partialProofData, commitment_0) {
    let t_1, t_2, t_0;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newArray()
                                                          .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_21.toValue(1n),
                                                                                                           alignment: _descriptor_21.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_20.toValue(1n),
                                                                                                                                                                                                     alignment: _descriptor_20.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue((t_1 = { commitment:
                                                                                                                                                                                                                                                                                                                                       commitment_0,
                                                                                                                                                                                                                                                                                                                                     contract_address:
                                                                                                                                                                                                                                                                                                                                       this._none_1(),
                                                                                                                                                                                                                                                                                                                                     ciphertext:
                                                                                                                                                                                                                                                                                                                                       this._none_0() },
                                                                                                                                                                                                                                                                                                                             t_2 = t_1.contract_address,
                                                                                                                                                                                                                                                                                                                             t_0 = t_1.ciphertext,
  ...
  _emitShieldedMint_0(context, partialProofData, commitment_0) {
    let t_0, t_1;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newArray()
                                                          .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_21.toValue(1n),
                                                                                                           alignment: _descriptor_21.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_20.toValue(2n),
                                                                                                                                                                                                     alignment: _descriptor_20.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue((t_0 = { commitment:
                                                                                                                                                                                                                                                                                                                                       commitment_0,
                                                                                                                                                                                                                                                                                                                                     domain_sep:
                                                                                                                                                                                                                                                                                                                                       new Uint8Array(32),
                                                                                                                                                                                                                                                                                                                                     amount:
                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                             Uint8Array.from([...Array.from(t_0.commitment,
                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                              :
                                                                                                                                                                                                                                                                                                                                              0n,
                                                                                                                                                                                                                                                                                                                                              ...Array.from(__compactRuntime.convertFieldToBytes(16,
                                                                                                                                                                                                                                                                                                                                                                                                 t_1.value,
  ...
  _emitShieldedBurn_0(context, partialProofData, nullifier_0) {
    let t_0, t_1;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newArray()
                                                          .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_21.toValue(1n),
                                                                                                           alignment: _descriptor_21.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_20.toValue(3n),
                                                                                                                                                                                                     alignment: _descriptor_20.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue((t_0 = { nullifier:
                                                                                                                                                                                                                                                                                                                                       nullifier_0,
                                                                                                                                                                                                                                                                                                                                     amount:
                                                                                                                                                                                                                                                                                                                                       this._some_0(1n) },
                                                                                                                                                                                                                                                                                                                             t_1 = t_0.amount,
  ...
  _emitUnshieldedSpend_0(context, partialProofData, tokenType_0, amount_0) {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newArray()
                                                          .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_21.toValue(1n),
                                                                                                           alignment: _descriptor_21.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_20.toValue(4n),
                                                                                                                                                                                                     alignment: _descriptor_20.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue((t_0 = { sender:
                                                                                                                                                                                                                                                                                                                                       sender_0,
                                                                                                                                                                                                                                                                                                                                     token_type:
                                                                                                                                                                                                                                                                                                                                       tokenType_0,
                                                                                                                                                                                                                                                                                                                                     amount:
  ...
  _emitUnshieldedReceive_0(context, partialProofData, tokenType_0, amount_0) {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newArray()
                                                          .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_21.toValue(1n),
                                                                                                           alignment: _descriptor_21.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_20.toValue(5n),
                                                                                                                                                                                                     alignment: _descriptor_20.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue((t_0 = { recipient:
                                                                                                                                                                                                                                                                                                                                       recipient_0,
                                                                                                                                                                                                                                                                                                                                     token_type:
                                                                                                                                                                                                                                                                                                                                       tokenType_0,
                                                                                                                                                                                                                                                                                                                                     amount:
  ...
  _emitUnshieldedMint_0(context, partialProofData, tokenType_0, amount_0) {
    let t_0;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newArray()
                                                          .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_21.toValue(1n),
                                                                                                           alignment: _descriptor_21.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_20.toValue(6n),
                                                                                                                                                                                                     alignment: _descriptor_20.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_4.toValue((t_0 = { domain_sep:
                                                                                                                                                                                                                                                                                                                                       new Uint8Array(32),
                                                                                                                                                                                                                                                                                                                                     token_type:
                                                                                                                                                                                                                                                                                                                                       tokenType_0,
                                                                                                                                                                                                                                                                                                                                     amount:
                                                                                                                                                                                                                                                                                                                                       amount_0 },
                                                                                                                                                                                                                                                                                                                             Uint8Array.from([...Array.from(t_0.domain_sep,
                                                                                                                                                                                                                                                                                                                                                            BigInt),
                                                                                                                                                                                                                                                                                                                                              ...Array.from(t_0.token_type,
                                                                                                                                                                                                                                                                                                                                                            BigInt),
                                                                                                                                                                                                                                                                                                                                              ...Array.from(__compactRuntime.convertFieldToBytes(16,
  ...
  _emitUnshieldedBurn_0(context, partialProofData, tokenType_0, amount_0) {
    const sender_0 = this._left_0({ bytes: new Uint8Array(32) });
    let t_0, t_1;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newArray()
                                                          .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_21.toValue(1n),
                                                                                                           alignment: _descriptor_21.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_20.toValue(7n),
                                                                                                                                                                                                     alignment: _descriptor_20.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue((t_0 = { sender:
                                                                                                                                                                                                                                                                                                                                       sender_0,
                                                                                                                                                                                                                                                                                                                                     token_type:
                                                                                                                                                                                                                                                                                                                                       tokenType_0,
  ...
  _emitLifecycle_0(context, partialProofData) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newArray()
                                                          .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_21.toValue(1n),
                                                                                                           alignment: _descriptor_21.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_20.toValue(8n),
                                                                                                                                                                                                     alignment: _descriptor_20.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_3.toValue(new Uint8Array([])),
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newArray()
                                                          .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_21.toValue(1n),
                                                                                                           alignment: _descriptor_21.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_20.toValue(9n),
                                                                                                                                                                                                     alignment: _descriptor_20.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_3.toValue(new Uint8Array([])),
                                                                                                                                                                                                                                                                                               alignment: _descriptor_3.alignment() }))
                                                          .encode() } },
                                       'log']);
